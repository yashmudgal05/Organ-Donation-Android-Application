...
public class recipient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message.setText("List of Recipients");
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference("recipient_app"), model.class)
                        .build();
        ...
        else
        {
            fb.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(new Intent(getApplicationContext(), addDataR.class));
                }
            });
        }
    ...
    public void processSearch(String s) {
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("recipient").orderByChild("organ").startAt(s).endAt(s+"\uf8ff"), model.class)
                        .build();
